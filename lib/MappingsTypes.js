...
module.exports = {
    list: function (itemsSchema) {
        ...
        return Joi.array().items(itemsSchema).meta({
            ...
            method: "list",
            arg: meta.cql,
            validators: [].concat([TYPE_MAP.list], meta.validators)
        });
    },
    blob: function () {
    ...
    frozen: function (nestedSchema) {
        ...
        meta.method = method;
        meta.arg = meta.cql;
        meta.validators = [].concat([TYPE_MAP.frozen], meta.validators);
        return nestedSchema;
    },
    ...
    reverse_clustering_key: function (itemSchema, index) {
        ...
        meta.component_index = index;
        meta.validators = [].concat([TYPE_MAP.reversed_type], meta.validators);
        return itemSchema;
    },
