...
module.exports = {
    ...
    // FIXME: wrapper added to avoid validation errors in UDTs
    ...
    list: function (itemsSchema) {
        return this.frozen(this._list(itemsSchema));
    },
    _list: function (itemsSchema) {
    ...
    map: function (keyItemsSchema, valueItemsSchema) {
        return this.frozen(this._map(keyItemsSchema, valueItemsSchema));
    },
    _map: function (keyItemsSchema, valueItemsSchema) {
