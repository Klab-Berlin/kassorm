...
function decamelizeKeys(rootSchema, obj) {
    if (obj === null) {
        return null;
    }
    ...
    if (Array.isArray(obj)) {
        return obj.map(function (v) {
            return decamelizeKeys(rootSchema.items[0], v);
        });
    }
    if (meta.mappings.indexOf("map") >= 0) {
        var r = {};
        Object.keys(obj).forEach(function (k) {
            r[k] = decamelizeKeys(meta.vMeta, obj[k]);
        });
        return r;
    }
    if (typeof obj === "object") {
        ...
        Object.keys(obj).forEach(function (k) {
            ...
            res[prefix + humps.decamelize(k)] = decamelizeKeys(rootSchema.children[k], obj[k]);
        });
        return res;
    }
    return obj;
...
Model.prototype.save = function (o) {
    this.validate(o);
    var obj = decamelizeKeys(this._schema, o);
...
var mapFieldNamesToJs = function (rootSchema, obj) {
    ...
    if (Array.isArray(obj)) {
        ...
        Object.keys(rootSchema.children).forEach(function (schemaFieldName) {
            var prefix = "";
            if (schemaFieldName.indexOf('_') == 0) {
                prefix = "underscore";
            }
            var field = rootSchema.children[schemaFieldName];
            //var fieldMeta = field.meta[field.meta.length - 1];
            var dbFieldName = prefix + humps.decamelize(schemaFieldName);
            if (obj[dbFieldName] != null) {
