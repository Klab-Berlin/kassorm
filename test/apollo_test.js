...
//        });
//
//        it('supports UDT', function (done) {
//            var address_schema = {
//                fields: {street: "text", city: "text"},
//                key: ["street", "city"]
//            };
//            var AddressModel = apollo.add_model("address", address_schema, {'mismatch_behaviour': 'drop'});
//
//            var person_schema = {
//                fields: {name: "text", address: AddressModel},
//                key: ["name"]
//            };
//            var PersonModel = apollo.add_model("user", person_schema, {'mismatch_behaviour': 'drop'});
//
//            //var a = new AddressModel({street: "street", city:"city"});
//            var p = new PersonModel({name: "name", address: {street: "street", city:"city"}});
//
//            p.save(function (err) {
//                if (err) return done(err);
//                PersonModel.find({name: "name"}, function (err, results) {
//                    assert.notOk(err);
//                    assert.lengthOf(results, 1);
//                    done();
//                });
